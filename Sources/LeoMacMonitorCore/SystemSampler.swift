...
//  Updated:   2026-07-14
//  Developer: Leo Yuan
//  Overview:  Aggregates every LeoMacMonitorCore sampler into one SystemSnapshot. Intended
...
//             handles, but LeoMacMonitor only ever calls sample() from one serial background
