...
当前 1.2.0 构建使用 Leo Yuan 的 Apple Development 证书签名。由于尚未使用 Developer ID
...
```bash
swift test
SIGN_ID="1082E6E97B4ADD052348041B0E960C25B7E0C370" scripts/build-app.sh 1.2.0
```
...
```bash
SIGN_ID="1082E6E97B4ADD052348041B0E960C25B7E0C370" scripts/build-dmg.sh 1.2.0
```
